...
ASTUAICharacter::ASTUAICharacter(const FObjectInitializer& ObjInit) : Super(ObjInit.SetDefaultSubobjectClass<USTUAIWeaponComponent>("WeaponComponent"))
{
    ...
    HealthWidgetComponent->SetWidgetSpace(EWidgetSpace::Screen); // чтобы отображался не в 3д пространстве, а проецировался на HUD
...
void ASTUAICharacter::OnDeath()
{
    ...
    {
        STUController->BrainComponent->Cleanup(); // когда персонаж умирает, останавливаем дерево поведения
    }
}
